...
# 축소할 차원 크기 (단어 하나 당 좌표 100개)
# 커널사이즈 (훈련 시 앞 뒤로 고려하는 단어 개수)
# 최소 빈도 수. 해당 빈도수보다 적게 등장하면 학습서 배제
# CPU 사용 갯수
# 학습 횟수
# 어떠한 알고리즘을 사용할 지 (sg는 Skip-gram)

embedding_moel.save('./models/word2VecModel_2016_2021.model')

print(embedding_moel.wv.vocab.keys())
print(len(embedding_moel.wv.vocab.keys()))
